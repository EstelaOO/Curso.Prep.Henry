...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
  objeto[property]= null; ///property es una variable que pasa por argumento, por eso no lleva ''
  return objeto;
}
...
function invocarMetodo(objeto, metodo) {
  ...
  // Tu código:
  objeto[metodo](); //se ejecita con los parentesis al final ()
}
...
function eliminarPropiedad(objeto, unaPropiedad) {
  ...
  // Devuelve el objeto
  // Tu código:
  delete objeto[unaPropiedad]; //para eliminar se usa 'delete'
  return objeto;
}
